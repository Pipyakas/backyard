use bollard::Docker;
use bollard::models::{ContainerCreateBody as Config, DeviceMapping, DeviceRequest, HostConfig};
...
impl Orchestrator {
    ...
    pub async fn start_engine(
        ...
        // On non-Linux, skip GPU passthrough
        ...
        let image = match gpu_type {
            ...
            _ => "backyard:llama-cuda".to_string(),
        };
